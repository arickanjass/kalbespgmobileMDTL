...
public class tPurchaseOrderHeaderData {
    ...
    public synchronized String get_txtNoOrder() {
        return _txtNoOrder;
    }

    public synchronized void set_txtNoOrder(String _txtNoOrder) {
    ...
    public String Property_ListOftPurchaseOrderHeaderData = "ListOftPurchaseOrderHeaderData";
    ...
    public tPurchaseOrderHeaderData() {
        super();
