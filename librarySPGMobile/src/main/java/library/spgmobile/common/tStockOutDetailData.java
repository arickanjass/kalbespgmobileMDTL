...
public class tStockOutDetailData {
    ...
    public String Property_ListOftOverStockDetailData = "ListOftStockOutDetailData";
    ...
    public tStockOutDetailData() {
        super();
    }

    public tStockOutDetailData(String intId, String _dtDate, String _intPrice, String _txtCodeProduct, String txtProduct,
