...
public class tKemasanRusakHeaderData extends APIData{
    ...
    public String Property_ListOftKemasanRusakHeaderData = "ListOftKemasanRusakHeaderData";

    public tKemasanRusakHeaderData() {
        super();
    }
