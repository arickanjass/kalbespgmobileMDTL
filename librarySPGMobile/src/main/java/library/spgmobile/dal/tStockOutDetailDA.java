...
public class tStockOutDetailDA {
    private static final String TABLE_CONTACTS = new clsHardCode().txtTable_tStockOutDetail;

    // Contacts Table Columns names

    public tStockOutDetailDA(SQLiteDatabase db) {
    ...
    // Adding new contact
    public void SaveDatatOverStockDetailData(SQLiteDatabase db, tStockOutDetailData data) {
        tStockOutDetailData dt = new tStockOutDetailData();
    ...
    public List<tStockOutDetailData> getDataNoOverStock(SQLiteDatabase db, String Noso) {
        List<tStockOutDetailData> contactList = null;
        tStockOutDetailData dt = new tStockOutDetailData();
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] { dt.Property_intId,
        ...
        if (cursor != null) {
            if (cursor.moveToFirst()) {
                contactList = new ArrayList<tStockOutDetailData>();
                do {
                    tStockOutDetailData contact = new tStockOutDetailData();
    ...
    // Getting single contact
    public List<tStockOutDetailData> getDataByTxtOverStock(SQLiteDatabase db, String id) {
        tStockOutDetailData dt = new tStockOutDetailData();
        List<tStockOutDetailData> contactList = new ArrayList<tStockOutDetailData>();
    ...
    // push data
    public List<tStockOutDetailData> getAllDataToPushData(SQLiteDatabase db, List<tStockOutHeaderData> ListOfSalesProductQuantityHeader) {
        List<tStockOutDetailData> contactList = null;
        // select All Query
        tStockOutDetailData dt = new tStockOutDetailData();
    ...
    public List<tStockOutDetailData> getAllDataKeep(SQLiteDatabase db, List<tStockOutHeaderData> ListOfSalesProductQuantityHeader) {
        List<tStockOutDetailData> contactList = null;
        // select All Query
        tStockOutDetailData dt = new tStockOutDetailData();
