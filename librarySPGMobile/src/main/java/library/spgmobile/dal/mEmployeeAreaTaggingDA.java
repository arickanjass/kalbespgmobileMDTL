...
import library.spgmobile.common.mEmployeeAreaTaggingData;

/**
 * Created by aan.junianto on 16/01/2018.
 */

public class mEmployeeAreaTaggingDA {
    public mEmployeeAreaTaggingDA(SQLiteDatabase db) {
    ...
    // Contacts table name
    private static final String TABLE_CONTACTS = new clsHardCode().txtTable_mEmployeeAreaTagging;
    ...
    // Adding new contact
    public void SaveDataMConfig(SQLiteDatabase db, mEmployeeAreaTaggingData data) {
        mEmployeeAreaTaggingData dt = new mEmployeeAreaTaggingData();
    ...
    public mEmployeeAreaTaggingData getData(SQLiteDatabase db, int id) {
        mEmployeeAreaTaggingData dt = new mEmployeeAreaTaggingData();
        ...
        if (cursor != null)
            cursor.moveToFirst();
        mEmployeeAreaTaggingData contact = new mEmployeeAreaTaggingData();
    ...
    public mEmployeeAreaTaggingData getDataByOutlet(SQLiteDatabase db, String idOutlet) {
        mEmployeeAreaTaggingData dt = new mEmployeeAreaTaggingData();
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] {
                        dt.Property_intID , dt.Property_intBranchId
                        , dt.Property_intChannelId
    ...
    public List<mEmployeeAreaTaggingData> getDataAreaByCabId(SQLiteDatabase db, String Cabid) {
        List<mEmployeeAreaTaggingData> contactList = new ArrayList<mEmployeeAreaTaggingData>();
        mEmployeeAreaTaggingData dt = new mEmployeeAreaTaggingData();
        Cursor cursor = db.query(TABLE_CONTACTS, new String[] {
                        dt.Property_intID , dt.Property_intBranchId
                        , dt.Property_intChannelId
        ...
        if (cursor.moveToFirst()) {
            do {
                contact = new mEmployeeAreaTaggingData();
                contact.set_intID(cursor.getString(0));
                contact.set_intBranchId(cursor.getString(1));
                contact.set_intChannelId(cursor.getString(2));
                contact.set_intEmployeeId(cursor.getString(3));
    ...
    public List<mEmployeeAreaTaggingData> getAllData(SQLiteDatabase db) {
        List<mEmployeeAreaTaggingData> contactList = new ArrayList<mEmployeeAreaTaggingData>();
        // Select All Query
        mEmployeeAreaTaggingData dt = new mEmployeeAreaTaggingData();
