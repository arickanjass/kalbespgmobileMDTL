...
public class mProductPICDA {
    ...
    public List<mProductPICData> getAllDataByKN(SQLiteDatabase db, List<mUserLOBData>  mUserLOBDataList, String txtNik) {
        List<mProductPICData> contactList = new ArrayList<mProductPICData>();
    ...
    public List<mProductPICData> getDataByMasterIdByKN(SQLiteDatabase db, String masterId, List<mUserLOBData> mUserLOBDataList) {
        List<mProductPICData> contactList = new ArrayList<mProductPICData>();
        // Select All Query
        mProductPICData data = new mProductPICData();
