...
public class tStockOutHeaderDA {
    // All Static variables

    // Contacts table name
    private static final String TABLE_CONTACTS = new clsHardCode().txtTable_tStockOutHeader;

    // Contacts Table Columns names

    public tStockOutHeaderDA(SQLiteDatabase db){
    ...
    // Adding new contact
    public void SaveDataOverStockData(SQLiteDatabase db, tStockOutHeaderData data) {
        tOverStockHeaderData dt = new tOverStockHeaderData();
...
//        }
    ...
    public int countOStockStatusSubmit(SQLiteDatabase db, String code) {
        ...
        String selectQuery = "select coalesce(sum(1),0) from [tStockOutHeader] where OutletCode='" + code + "' and intSubmit=1 and [intSync]=0";
    ...
    public int countOStockPush(SQLiteDatabase db,  String code) {
        String selectQuery = "select coalesce(sum(1),0) from [tStockOutHeader] where OutletCode='" + code + "' and intSubmit=1 and [intSync]=1";
    ...
    public int getAllCheckPushData(SQLiteDatabase db) {
        List<tStockOutHeaderData> contactList = null;
        // Select All Query
        tStockOutHeaderData dt = new tStockOutHeaderData();
    ...
    public List<tStockOutHeaderData> getAllDataToPushData(SQLiteDatabase db){
        List<tStockOutHeaderData> contactList = null;
        // Select All Query
        tStockOutHeaderData dt = new tStockOutHeaderData();
        ...
        if (cursor.moveToFirst()) {
            contactList = new ArrayList<tStockOutHeaderData>();
            do {
                tStockOutHeaderData contact = new tStockOutHeaderData();
                contact.set_intId(cursor.getString(0));
                contact.set_txtOverStock(cursor.getString(1));
    ...
    public List<tStockOutHeaderData> getAllData(SQLiteDatabase db) {
        List<tStockOutHeaderData> contactList = null;
        // select all query
        tStockOutHeaderData dt = new tStockOutHeaderData();
    ...
    public List<tStockOutHeaderData> getAllDataByOutletCode(SQLiteDatabase db, String code){
        List<tStockOutHeaderData> contactList = null;
        // select all query
        tStockOutHeaderData dt = new tStockOutHeaderData();
    ...
    public List<tStockOutHeaderData> getDataByTxtOverStock(SQLiteDatabase db, String id){
        List<tStockOutHeaderData> contactList = new ArrayList<tStockOutHeaderData>();
        // select all query
        tStockOutHeaderData dt = new tStockOutHeaderData();
    ...
    public List<tStockOutHeaderData> getLastData(SQLiteDatabase db) {
        List<tStockOutHeaderData> contactList = null;
        // select all query
        tStockOutHeaderData dt = new tStockOutHeaderData();
