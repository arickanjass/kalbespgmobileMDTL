...
public class tAttendanceUserDA {
    // All Static variables

    // Contacts table name
    private static final String TABLE_CONTACTS = new clsHardCode().txtTable_tAttendanceUser;

    // Contacts Table Columns names

    public tAttendanceUserDA(SQLiteDatabase db) {
    ...
    // Adding new contact
    public void SaveDatatAbsenUserData(SQLiteDatabase db,tAttendanceUserData data) {
...
//					contact.set_txtImg2(cursor.getString(16));
    ...
    public tAttendanceUserData getDataCheckInActive(SQLiteDatabase db) {
        // Select All Query
        tAttendanceUserData dt=new tAttendanceUserData();
        ...
        Cursor cursor = db.rawQuery(selectQuery, null);
        tAttendanceUserData contact = null;
        // looping through all rows and adding to list
        if (cursor.moveToFirst()) {
            do {
                contact=new tAttendanceUserData();
                contact.set_intId(cursor.getString(0));
                contact.set_dtDateCheckIn(cursor.getString(1));
...
//					contact.set_txtImg2(String.valueOf(bmp2));
    ...
    public List<tAttendanceUserData> getAllDataActive(SQLiteDatabase db) {
        List<tAttendanceUserData> contactList = null;
        // Select All Query
        tAttendanceUserData dt=new tAttendanceUserData();
