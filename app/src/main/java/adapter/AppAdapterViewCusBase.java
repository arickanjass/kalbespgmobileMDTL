...
public class AppAdapterViewCusBase extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = View.inflate(context, com.example.salesforcelibrary.R.layout.item_list_app2, null);
    ...
    class ViewHolder {
        ...
        public ViewHolder(View view) {
            iv_icon = (ImageView) view.findViewById(com.example.salesforcelibrary.R.id.icon);
            tv_id = (TextView) view.findViewById(com.example.salesforcelibrary.R.id.title);
            tv_name = (TextView) view.findViewById(com.example.salesforcelibrary.R.id.description);
            tv_status = (TextView) view.findViewById(com.example.salesforcelibrary.R.id.description1);
