 ...
 */
public class FragmentViewResoSPGEnhance extends Fragment implements IXListViewListener {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!noso.equals("")){
                    ...
                    FragmentAddResoSPGEnhance fragmentAddResoSPG = new FragmentAddResoSPGEnhance();
