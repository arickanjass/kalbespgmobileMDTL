...
public class FragmentViewStockOutTL extends Fragment implements IXListViewListener {
    View v;
    ...
    static List<tStockOutDetailData> data;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                toolbar.setTitle("Add Stock Out");

                FragmentAddStockOutTL fragmentAddOverStockTL = new FragmentAddStockOutTL();
                FragmentTransaction fragmentTransaction = getFragmentManager().beginTransaction();
                fragmentTransaction.replace(R.id.frame, fragmentAddOverStockTL);
    ...
    private void viewList(Context ctx, int position) {
        ...
        _tvNoSO.setText(dt.get(position).get_txtOverStock());
        ...
        data = new tStockOutDetailBL().GetDataNoOverStock(dt.get(position).get_txtOverStock());
...
//        tAbsenUserData dtActive = new tAbsenUserBL().getDataCheckInActive();
        ...
        dt = new tStockOutHeaderBL().getAllOverStockHeaderByOutletCode(dtActive.get_txtOutletCode());
        ...
        if (dt != null) {
            for (int i = 0; i < dt.size(); i++) {
                ...
                swplist.set_txtTitle(dt.get(i).get_txtOverStock());
